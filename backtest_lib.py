...
# Define an overarching forex backtest function, including the ability optimize parameters, symbols, timeframes, and use multiprocessing
...
def display_backtest_results(backtest_results, raw_candlesticks, strategy_candlesticks):
    ...
    print("==================================", backtest_results)
    win_objects = backtest_results.get('win_objects')
    ...
    loss_objects = backtest_results.get('loss_objects')
    # Convert to a dataframe
    ...
    proposed_trades = strategy_candlesticks.get(
...
def calculate_backtest_results(results_dict, contract_size, parameters, raw_strategy_candles, proposed_trades):
    ...
    results_dict = {'win_objects': [3, 2, 1, 0], 'col_2': ['a', 'b', 'c', 'd']}
    print(results_dict)
...
if __name__ == '__main__':
    # Example usage of the display_backtest_results function
    # Create dummy figures for demonstration
    backtest_results = {}  # Replace {} with your actual backtest results
    raw_candlesticks = {}  # Replace {} with your actual raw candlesticks
    strategy_candlesticks = {}  # Replace {} with your actual strategy candlesticks

    # Call the display_backtest_results function
    display_backtest_results(backtest_results, raw_candlesticks, strategy_candlesticks)